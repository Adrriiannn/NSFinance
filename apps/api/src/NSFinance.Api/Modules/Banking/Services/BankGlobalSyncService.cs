    ...
    ILogger<BankGlobalSyncService> logger)
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        {
            var cooldownState = await GetManualCooldownStateAsync(userId, requestedAtUtc, cancellationToken);
        ...
        foreach (var candidate in eligibleCandidates)
        {
            ...
            var syncResult = await bankSyncService.SyncConnectionAsync(userId, candidate.Id, cancellationToken);
