...
public sealed class JwtOptions
{
    ...
    public string Issuer { get; set; } = "NSFinance.Api";
    public string Audience { get; set; } = "NSFinance.Mobile";
    public string SigningKey { get; set; } = "CHANGE_ME_FOR_PRODUCTION_NSFINANCE_SIGNING_KEY";
