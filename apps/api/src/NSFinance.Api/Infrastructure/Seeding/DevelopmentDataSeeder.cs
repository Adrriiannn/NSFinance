    ...
    IPasswordHasher passwordHasher)
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        if (user is null)
        {
            ...
            {
                Id = demoUserId,
                PrimaryEmail = "demo@nsfinance.local",
                NormalizedEmail = "demo@nsfinance.local",
                DisplayName = "Aoife Murphy",
                FullName = "Aoife Murphy",
                Handle = "aoife",
                ProfileSubtitle = "Focused on: saving more",
                Status = "active",
                ...
                FinancialFocusJson = "[\"Save more money\",\"Track subscriptions\"]"
            };
