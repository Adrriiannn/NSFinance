...
namespace NSFinance.Api.Persistence.Migrations
{
    ...
    [Migration("20260924210238_AddMerchantKnowledgeSeedRuns")]
    partial class AddMerchantKnowledgeSeedRuns
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NSFinance.Api.Persistence.Entities.LinkedBankAccount", b =>
                {
                    ...
                    b.Property<DateTime?>("TransactionSyncCoverageUtc")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("NSFinance.Api.Persistence.Entities.MerchantKnowledge", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<int>("CharacteristicsVersion")
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("DirectionExpectation")
                        .IsRequired()
                        .HasMaxLength(20)
                        .HasColumnType("character varying(20)");
                    ...
                    b.Property<DateTime?>("LastMatchedUtc")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.HasIndex("UserId", "NormalizedPattern")
                        .IsUnique();

                    b.ToTable("MerchantKnowledge", (string)null);
                });

            modelBuilder.Entity("NSFinance.Api.Persistence.Entities.MerchantKnowledgeCandidate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("InvestigationSummaryJson")
                        .HasColumnType("jsonb");
                    ...
                    b.Property<DateTime?>("NextEligibleUtc")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.Property<string>("ObservedDirection")
                        .IsRequired()
                        .HasMaxLength(20)
                        .HasColumnType("character varying(20)");

                    b.Property<int>("ObservedOccurrences")
                        .HasColumnType("integer");

                    b.Property<decimal>("ObservedSpendAbs")
                        .HasPrecision(18, 2)
                        .HasColumnType("numeric(18,2)");

                    b.Property<Guid?>("PromotedKnowledgeId")
                        .HasColumnType("uuid");

                    b.Property<double?>("ProposedConfidence")
                        .HasColumnType("double precision");

                    b.Property<int?>("ProposedTaxonomyCategoryId")
                        .HasColumnType("integer");

                    b.Property<int?>("ProposedTaxonomyDomainId")
                        .HasColumnType("integer");

                    b.Property<int?>("ProposedTaxonomySubcategoryId")
                        .HasColumnType("integer");

                    b.Property<string>("RawDescriptorSample")
                        .IsRequired()
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)");
                    ...
                    b.HasIndex("Status", "NextEligibleUtc");

                    b.ToTable("MerchantKnowledgeCandidates", (string)null);
                });

            modelBuilder.Entity("NSFinance.Api.Persistence.Entities.MerchantKnowledgeCurationIssue", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("KnowledgeId", "IssueType");

                    b.ToTable("MerchantKnowledgeCurationIssues", (string)null);
                });

            modelBuilder.Entity("NSFinance.Api.Persistence.Entities.MerchantKnowledgeFinding", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("CandidateId", "FindingVersion")
                        .IsUnique();

                    b.ToTable("MerchantKnowledgeFindings", (string)null);
                });

            modelBuilder.Entity("NSFinance.Api.Persistence.Entities.MerchantKnowledgeSeedRun", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<int>("RetargetedCount")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("CharacteristicsVersion")
                        .IsUnique();

                    b.ToTable("MerchantKnowledgeSeedRuns", (string)null);
                });
            ...
            modelBuilder.Entity("NSFinance.Api.Persistence.Entities.ReferenceLaneJudgment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("TransactionId", "CharacteristicsVersion")
                        .IsUnique();

                    b.HasIndex("UserId", "JudgedUtc");

                    b.ToTable("ReferenceLaneJudgments", (string)null);
                });
            ...
            modelBuilder.Entity("NSFinance.Api.Persistence.Entities.Transaction", b =>
                {
                    ...
                    b.Property<int?>("CategorizationCharacteristicsVersion")
                        .HasColumnType("integer");

                    b.Property<string>("CategorizationRuleKey")
                        .HasColumnType("text");

                    b.Property<string>("CategorizationSignal")
                        .HasColumnType("text");
