...
type ChipPresetStyles = {
  chipPresets: Record<ChipVariant, { container: ViewStyle; label: TextStyle }>;
  chipToneStyles: Record<ChipTone, ViewStyle>;
  chipSelectedStyle: ViewStyle;
};

export function useChipPresetStyles(): ChipPresetStyles {
  ...
  return useMemo(() => {
    ...
    const chipPresets: Record<ChipVariant, { container: ViewStyle; label: TextStyle }> = {
      filter: {
        container: {
          ...baseChip,
    ...
    const chipToneStyles: Record<ChipTone, ViewStyle> = {
      default: {
        backgroundColor: surfaces.section
      },
      success: {
    ...
    const chipSelectedStyle: ViewStyle = {
