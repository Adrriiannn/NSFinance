...
const domainVisuals: Record<number, { color: string; icon: string }> = {
  100: { color: "#1DBA72", icon: "home-outline" },
  110: { color: "#FFBE7A", icon: "leaf-outline" },
  120: { color: "#F0B44C", icon: "car-outline" },
  130: { color: "#F28C28", icon: "restaurant-outline" },
  140: { color: "#FF9F43", icon: "flash-outline" },
  150: { color: "#B88A65", icon: "shield-checkmark-outline" },
  160: { color: "#1DBA72", icon: "medkit-outline" },
  170: { color: "#F28A8A", icon: "card-outline" },
  180: { color: "#F0B44C", icon: "trending-up-outline" },
  190: { color: "#FF9F43", icon: "sparkles-outline" },
  200: { color: "#6ED0A8", icon: "people-outline" },
  210: { color: "#C08CFF", icon: "game-controller-outline" },
  220: { color: "#F28C28", icon: "airplane-outline" },
  230: { color: "#FF8FA3", icon: "bag-handle-outline" },
  240: { color: "#FFBE7A", icon: "gift-outline" },
  250: { color: "#8ED9C4", icon: "paw-outline" },
  260: { color: "#B88A65", icon: "school-outline" },
  270: { color: "#F0A15B", icon: "receipt-outline" },
  280: { color: "#F0B44C", icon: "repeat-outline" },
  290: { color: "#F0B44C", icon: "briefcase-outline" },
  300: { color: "#B88A65", icon: "heart-outline" },
  310: { color: "#9A9A9A", icon: "document-text-outline" },
  900: { color: "#9A9A9A", icon: "swap-horizontal-outline" },
  910: { color: "#78D1A3", icon: "cash-outline" },
  920: { color: "#F0B44C", icon: "repeat-outline" }
};
