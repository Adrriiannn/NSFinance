      ...
      {query.isError ? (
        ...
        <View style={styles.body}>
          ...
          <Text style={styles.paragraph}>
            Terms content is referenced by: {query.data.contentReference}
          </Text>
          <SecondaryButton label="Privacy Policy" onPress={() => router.push("/legal/privacy" as never)} />
        </View>
      ) : (
        <Text style={styles.meta}>Loading terms...</Text>
      )}
    </ScreenContainer>
  );
}
