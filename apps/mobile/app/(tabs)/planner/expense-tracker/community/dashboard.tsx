...
export default function ExpensePlanCommunityDashboardScreen() {
  ...
  return (
    <ExpenseTrackerMiniAppScreen title="My published plans">
      ...
      {dashboard.plans.length === 0 ? (
        ...
        <View style={styles.planList}>
          {dashboard.plans.map((publication) => (
            <Pressable key={publication.id} style={styles.planCard} onPress={() => router.push(`/(tabs)/planner/expense-tracker/community/${publication.id}` as never)}>
