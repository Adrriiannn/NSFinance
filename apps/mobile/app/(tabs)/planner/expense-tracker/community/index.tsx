...
export default function ExpensePlanCommunityBrowserScreen() {
  ...
  return (
    <ExpenseTrackerMiniAppScreen title="Community plans">
      <GlassCard style={styles.heroCard}>
        ...
        <View style={styles.heroActions}>
          <Pressable style={styles.heroActionButton} onPress={() => router.push("/(tabs)/planner/expense-tracker/community/publish" as never)}>
          ...
          <Pressable style={styles.heroActionButton} onPress={() => router.push("/(tabs)/planner/expense-tracker/community/dashboard" as never)}>
            <Ionicons name="stats-chart-outline" size={16} color={palette.textPrimary} />
            <Text style={styles.heroActionLabel}>Creator dashboard</Text>
          </Pressable>
        </View>
      </GlassCard>
      ...
      <View style={styles.sectionWrap}>
        ...
        <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={styles.featureRail}>
          {sections.featured.map((publication) => (
            <Pressable key={publication.id} style={styles.featureCard} onPress={() => router.push(`/(tabs)/planner/expense-tracker/community/${publication.id}` as never)}>
      ...
      <View style={styles.sectionWrap}>
        ...
        <View style={styles.stackList}>
          {sections.popularThisWeek.slice(0, 3).map((publication) => (
            <Pressable key={publication.id} style={styles.rowCard} onPress={() => router.push(`/(tabs)/planner/expense-tracker/community/${publication.id}` as never)}>
        ...
        {filtered.length === 0 ? (
          ...
          <View style={styles.stackList}>
            {filtered.map((publication) => (
              <Pressable key={publication.id} style={styles.libraryCard} onPress={() => router.push(`/(tabs)/planner/expense-tracker/community/${publication.id}` as never)}>
